...
OUT_DIR='/data/projects/punim1637/Aleix/SV/Manila/RNA-seq/data'
OUT_DIR_FILE=/data/projects/punim1637/Aleix/SV/Manila/RNA-seq/data/${FILE}
...
if test -f ${FILE}_1.fastq.gz; then
    ...
    samtools markdup -r ${OUT_DIR_FILE}.bam ${OUT_DIR_FILE}2.bam
	mv ${OUT_DIR_FILE}2.bam ${OUT_DIR_FILE}.bam
...
done < /data/projects/punim1637/Aleix/SV/Manila/RNA-seq/data/L1_samples_rv80.txt

conda activate rnaseq

featureCounts -a /data/gpfs/projects/punim1637/Aleix/SV/Manila/RNA-seq/data/Mycobacterium_tuberculosis_H37Rv_gff_v5_modified.gff -o ${OUT_DIR}counts.txt -s 0 -Q 10 ${OUT_DIR}/*.bam -t CDS -g Locus -p
