...
OUT_DIR='/scratch/punim1637/Dunstan/SV/vcf/short_reads/'
OUT_DIR_FILE=/scratch/punim1637/Dunstan/SV/vcf/short_reads/${FILE}
...
kraken2 --paired --threads 30 --db ${DB_DIR}/HPRC_db/db/ --memory-mapping --output ${OUT_DIR_FILE}_classifications.tsv ${OUT_DIR_FILE}_1_trim.fastq ${OUT_DIR_FILE}_2_trim.fastq
...
minimap2 --secondary=no -c -t 30 -x sr -o ${OUT_DIR_FILE}_reads.aln.paf ${DB_DIR}/Mycobacterium_db/Mycobacterium.rep.fna.gz ${OUT_DIR_FILE}_1_depleted.fq ${OUT_DIR_FILE}_2_depleted.fq
...
shovill --force --gsize 4.4M --cpus 30 --outdir ${OUT_DIR_FILE}_asm --R1 ${OUT_DIR_FILE}_1_trim.fastq.gz --R2 ${OUT_DIR_FILE}_2_trim.fastq.gz
...
python3 ${SCRIPT}/modify_sv_vcf.py -b ${OUT_DIR_FILE}_map2pan_short.bed -v ${OUT_DIR_FILE}_pan_short.vcf -g ${PAN_DIR}/Mtb_PRG.gfa -o ${OUT_DIR_FILE}_mod_short.vcf

rm ${OUT_DIR_FILE}_pan_short.vcf

python3 ${SCRIPT}/refine_vcf.py -v ${OUT_DIR_FILE}_mod_short.vcf -o ${OUT_DIR_FILE}_ref_short.vcf

rm ${OUT_DIR_FILE}_mod_short.vcf
rm ${OUT_DIR_FILE}_asm.fasta
rm ${OUT_DIR_FILE}_map2pan_short.bed

python3 ${SCRIPT}/ins2dup.py -c ${OUT_DIR_FILE}_ref_short.vcf -r /data/gpfs/projects/punim1637/Shared/Data/Pathogen/Thai/Tutorials/Tutorial_04_Useful_Resources/TB.REF.GENOME.H37RV.ONELINE.fa
